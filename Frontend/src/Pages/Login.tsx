...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    const successUrl = `${import.meta.env.VITE_FRONTEND_BASE_URL}/dashboard`;
...
/>
          ...
          <div className="w-full lg:w-1/2 p-8 sm:p-10 flex flex-col justify-center">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-500 text-md mt-1">Continue your mental wellness journey</p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 border border-gray-300 py-3 rounded-lg hover:bg-gray-50 transition-all duration-300 shadow-sm"
              >
